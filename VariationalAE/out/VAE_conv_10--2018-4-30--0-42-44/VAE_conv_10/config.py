...
""" Training """
BATCH_SIZE = 1200 # the trainingset must be dividable with batches_size
EPOCHS = 10000
...
PLOT_LATENT_SPACE_EVERY = 20 #How often to plot the latent space, 1= every epoch, 10 every 10th etc.
PLOT_SIZE = 720 #px
