...
for epochnumber in range(20):
    ...
    print(epochnumber)
    print ("Reconstruction Loss:", model_ae.evaluate(x_train, x_train, verbose=1))
    print ("Adverserial Loss:", model_enc_disc.evaluate(x_train, np.ones(len(x_train)), verbose=1))
