...
mu = flat_2(convoluted_flat)
log_sigma = flat_3(convoluted_flat)
...
plt.savefig(
  "./VariationalAE/progress_images/no_hidden_layers_epoch{}-h1_size{}-h2_size{}-dropout{}.jpg".format(n_epoch, hidden_1_size, hidden_2_size, dropout_amount)
  )
plt.show()
#---------------------------------------------------------------------------------------------------------------------------------
#----------------------------------------------