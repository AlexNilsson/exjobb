<template>
  <div class="demo">
    ...
    <b-alert v-if="hasWebGL == false" variant="danger" dismissible :show="showDismissibleAlert" @dismissed="showDismissibleAlert=false">
      ...
      <b-row>
        ...
        <b-col>
          <div class="controls-column">
            <div class="control">
              <p>use GPU</p>
              <toggle-button v-model="useGPU" :disabled="modelLoading || modelInitializing || !hasWebGL"/>
            </div>
    ...
    <layer-explorer
      :modelLoading="modelLoading"
      :layerOutputImages="layerOutputImages"
      :layerDisplayConfig="layerDisplayConfig"
    />
...
const MODEL_FILEPATH_DEV = 'https://transcranial.github.io/keras-js-demos-data/mnist_vae/mnist_vae.bin' //'/demos/data/mnist_vae/mnist_vae.bin'
...
export default {
  ...
  components: { ModelStatus, LayerExplorer },
  ...
  .input-column {
    ...
    .input-container {
      ...
      .canvas-container {
        ...
        border: 15px solid @color-green-lighter;
