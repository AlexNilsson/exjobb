...
class VAE:
  ...
  def buildDecoder(self):
    ...
    x = Reshape((1,1,C.Z_LAYER_SIZE))(x)
    # (1, 1, z)
    
    x = Conv2DTranspose(512, 4, strides=1, activation='relu', padding='same')(x)
    x = BatchNormalization(momentum=0.8)(x)
    # (4, 4, 512)
    ...
    x = Conv2DTranspose(512, 5, strides=2, activation='sigmoid', padding='same')(x)
    # (64, 64, 3)
