...
""" Data """
DATASET = 'csv_mnist_gan'
IMG_SIZE = 28 # 320 # must be dividable by 8
...
BATCH_SIZE = 500 # the trainingset must be dividable with batches_size
EPOCHS = 10000
...
GENERATED_IMAGE_RANGE = (0, 1)

PLOT_LATENT_SPACE_EVERY = 100 #How often to plot the latent space, 1= every epoch, 10 every 10th etc.
PLOT_SIZE = 720 #px
